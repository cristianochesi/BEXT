...
public class GraphView extends View {
    ...
    public GraphView(Context context, AttributeSet attrs) {
        ...
        if (palette.length != MainActivity.MAX_SENSOR_VALUES)
            Logging.fatal("Internal limit palette " + palette.length + " does not match sensors " + MainActivity.MAX_SENSOR_VALUES);
